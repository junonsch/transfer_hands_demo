...
from resnet34f1.config import wandb_config
...
def train_tune_model_cv(device, model_conv, image_datasets, 
    ...
    if tuned:
        ...
        tuned = "featex"
    torch.save(model_conv.state_dict(), f'models/f1_{tuned}_resnet34model_conv_{timestr}.pt')
    torch.save(loss_values, f'loss_values/f1_{tuned}_resnet34_loss_values_{timestr}.pkl')
    torch.save(f1_values, f'f1_values/f1_{tuned}_resnet34_f1_values_{timestr}.pkl')
    wandb.finish()
