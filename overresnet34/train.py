...
from overresnet34.config import wandb_config
...
def train_tune_model_cv(device, model_conv, image_datasets, 
    ...
    if tuned:
        ...
        tuned = "featex"
    torch.save(model_conv.state_dict(), f'models/{tuned}_overresnet34model_conv_{timestr}.pt')
    torch.save(loss_values, f'loss_values/{tuned}_overresnet34_loss_values_{timestr}.pkl')
    torch.save(acc_values, f'acc_values/{tuned}_overresnet34_acc_values_{timestr}.pkl')
    wandb.finish()
