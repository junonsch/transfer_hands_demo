...
source venv.sh
SWEEP_ID_OVERRESNETF1_FEATEX=wandb agent junonsch/transfer_hands-overresnet34f1/y7fs63js

echo 'starting agent in sweep $SWEEP_ID_OVERRESNETF1_FEATEX ...'
wandb agent --count 1 ${SWEEP_ID_OVERRESNETF1_FEATEX}
echo 'finished agent in sweep $SWEEP_ID_OVERRESNETF1_FEATEX .'
