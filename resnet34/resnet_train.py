...
wandb.init(project=f"train_hypertuned_resnet34")
>>>>>>> bc103a0036b247e5f0925c090224661f8384037a
...
<<<<<<< HEAD
model_cv = train_model_cv(device, model_conv, image_datasets,
=======
...
torch.save(model_cv.state_dict(), f'models/TRAINED_{tuned}_resnet34model_conv_{timestr}.pt')
